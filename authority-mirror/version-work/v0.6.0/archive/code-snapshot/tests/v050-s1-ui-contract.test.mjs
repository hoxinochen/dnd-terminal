...
assert.match(app,/const SESSION_ENVELOPE_SCHEMA_VERSION = V060_SESSION_SCHEMA_VERSION;/);
assert.match(app,/const STORAGE_KEY = V060_STORAGE_KEY;/);
assert.match(index,/DND Terminal v0\.6\.0 — DM Ruling Implementation/);
assert.match(index,/src\/app\.js\?v=20260831-2/,'Chrome must load the current app bundle after Amendment 01');
